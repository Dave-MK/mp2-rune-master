            ...
            className={classNames(
                {
                    ...
                    ["bg-[url('/mp2-thats-the-word/src/assets/images/oop.png')] bg-center bg-contain bg-no-repeat bg-transparent oop-tile-text border-2"]: state === 'outofplace' && revealColour,
                },
