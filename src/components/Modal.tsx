                    ...
                    >
                        ...
                        <ol className="flex flex-col justify-start overscroll-contain w-fit h-[40vh] items-center text-center overflow-y-scroll snap-start border-t-amber-800 border-b-amber-800 p-1">
                            <li className="flex flex-col justify-center items-center p-1 mb-1">
                                ...
                                <div className="flex">
                                    <img src="./src/assets/images/correct.webp" className="w-8 m-1" alt="Gold rune, correctly placed - 1" />
                                    <img src="./src/assets/images/correct.webp" className="w-8 m-1" alt="Gold rune, correctly placed - 2" />
                                    <img src="./src/assets/images/correct.webp" className="w-8 m-1" alt="Gold rune, correctly placed - 3" />
                                    <img src="./src/assets/images/correct.webp" className="w-8 m-1" alt="Gold rune, correctly placed - 4" />
                                    <img src="./src/assets/images/correct.webp" className="w-8 m-1" alt="Gold rune, correctly placed - 5" />
                                </div>
                                <p className="p-2">
                            ...
                            <li className="flex flex-col justify-center items-center p-1 mb-1">
                                ...
                                <h2>Rune of Ivory</h2>
                                <img src="./src/assets/images/tile.webp" className="w-8 mb-1" alt="Ivory rune, no inscription" />
                                <p>
                            ...
                            <li className="flex flex-col justify-center items-center mb-3">
                                ...
                                <img src="./src/assets/images/oop.webp" className="w-12 mb-3" alt="Weathered gold rune, incorrect position" />
                                <p>
                            ...
                            <li className="flex flex-col justify-center items-center mb-3">
                                <h2>Rune of Decay</h2>
                                <img src="./src/assets/images/wrong.webp" className="w-12 mb-3" alt="Rune of decay, not in solution"/>
                                <p>
                            ...
                            <li className="flex flex-col justify-center items-center mb-3">
                                ...
                                <img src="./src/assets/images/correct.webp" className="w-12 mb-3" alt="Rune of the master, correctly placed" />
                                <p>
